...
if($nr==0){ 
  echo "<div class='msg'> <p  class='msg1'> il existe  pas des Messages </p> </div>";
 ...
 echo"<th class='titletabl'>N°</th>\n";
    echo"<th class='titletabl'>Nom</th>\n";
    echo"<th class='titletabl'>Prenom</th>\n";
             echo"  <th   class='titletabl'> email </th>\n";
             echo"  <th class='titletabl'>  Message</th>\n";
          
             echo"  <th class='titletabl'>  Supprimer</th>\n";
            
echo"</tr> \n";
while($row = $resulta->fetch_assoc()){
 
    echo"<tr style='  line-height: 25px; nth-child(even){background-color:brown;};height:37px; background-color:burlywood; color:brown '>\n";
    echo"<th style='  line-height: 25px; background-color:brown;color:white;' class='titletabl'>$row[id_Message]</th>\n";
    echo"<th style='  line-height: 25px; background-color:brown;color:white;' class='titletabl'>$row[Nom]</th>\n";
  echo"<th style='   line-height: 25px; background-color:brown;color:white;' class='titletabl'>$row[Prenom]</th>\n";
           echo"  <th  style='    line-height: 25px; background-color:brown;color:white;' class='titletabl'> $row[email]</th>\n";
           echo"  <th  style='   line-height: 25px; background-color:brown; color:white;' class='titletabl'> $row[Messag] </th>\n";     
           echo"<form   method='POST' >";
           echo"  <th  style=' line-height: 32px;background-color:brown; color:white;' class='titletabl'> <input type='submit' name='sup' value='Supprimer' class='lire'> \n"; 
           echo"  <th  style='   line-height: 25px;background-color:brown; color:white;' class='titletabl'> <input type='hidden' name='hiddnid' value='$row[id_Message]' > \n"; 
           echo"</form>";
           echo"</tr> \n";
