...
$sql="SELECT * from visiteur WHERE Type=2";
$resulta=mysqli_query($conn,$sql);
$nr=mysqli_num_rows($resulta);

if($nr==0){ 
 
  echo "<div class='msg'> <p  class='msg1'> il existe  pas de patient</p> </div>";
}
else{
  echo " <table   style=' width:95% ; text-align:center; border:1px;margin-left:22px;height:100px;'>\n" ;
...
while($row = $resulta->fetch_assoc()){
  echo"<tr style=' nth-child(even){background-color:brown;}; background-color:burlywood; color:brown; height:30px;'>\n";
